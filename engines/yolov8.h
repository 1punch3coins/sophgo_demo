...
public:
    Yolov8(float obj_threshold = 0.4, float cls_threshold = 0.2, float iou_threshold = 0.5, float same_id_iou_threshold = 0.9):
        obj_confidence_threshold_(obj_threshold), cls_confidence_threshold_(cls_threshold), nms_iou_threshold_(iou_threshold), nms_seperate_id_iou_threshold_(same_id_iou_threshold)
    {}
